...
# Transaction 1 should abort since participant 1 votes NO and transaction 2 should commit because of unanimous YES.
...
# Participant 1 fails before sending back the vote, master should timeout and abort the transaction.
...
# Master fails after sending the vote requests and didn't get back the votes, abort directly and notify every participant after recovery.
...
# Network partition occurs after the vote requests and cut the graph into 2 groups,[master and participant 1] and [participant 2] and recover after decision was made
